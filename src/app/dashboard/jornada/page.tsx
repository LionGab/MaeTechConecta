  ...
  return (
    <div className="space-y-12">
      ...
      <div className="space-y-8">
        <h2 className="flex items-center gap-2 font-headline text-2xl font-bold"><Milestone /> Módulos de Crescimento</h2>
       ...
       <div className="space-y-8">
          <h2 className="flex items-center gap-2 font-headline text-2xl font-bold"><Newspaper /> Artigos para Você</h2>
