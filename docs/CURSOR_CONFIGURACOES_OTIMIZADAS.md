# ⚙️ Configurações Otimizadas do Cursor 2.0

**Configurações de alta performance para desenvolvimento React Native + Expo**
...
Configurações do Composer e Multi-Agente:

- Configurações do Composer
- Configurações do Multi-Agente
- Agentes configurados (8 agentes)
- Browser integrado
- Sandbox
- Workflows
